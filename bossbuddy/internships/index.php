...
if (isset($_POST['upload'])) {
    ...
    // Check if $uploadOk is set to 0 by an error
        ...
        if (move_uploaded_file($_FILES["resume"]["tmp_name"], $target_file)) {
            ...
            $stmt = $pdo->prepare("insert into applications (username,resume,internshipSl) values(:username,:resume,:internshipSl)");
            $stmt->execute(
                array(
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active" id="active">
                    <a id="navlink" class="nav-link" href="#">Internships</a>
                </li>
                <li class="nav-item">
        ...
        if(!isset($_SESSION['logged'])){
            ...
            <div id="searchBar">
                <h3><i class="fas fa-search" style="color: var(--secondary);"></i>
                    <input name="search" id="search" type="text" placeholder="Search for Internships" autocomplete="off">
                </h3>
            </div>
            <div id="headerbtn">
                ...
                <a href="#postInternshipanchor" style="text-decoration: none;color:white;"><button class="btn btn-primary"><h5>Post Internships</h5></button></a>
            </div>
        </div>
                        ...
                        <form name="postInternshipForm" onsubmit="return postInternship()">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="pLocation" class="form-control" required>
                                </div>
                                <div class="col-md-6">
